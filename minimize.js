...
// this includes loops because they shadow any inner unlabeled break or continue statements
let triviallyNotBreakOrContinueTypes = ['DebuggerStatement', 'DoWhileStatement', 'EmptyStatement', 'ExpressionStatement', 'ForInStatement', 'ForOfStatement', 'ForAwaitStatement', 'ForStatement', 'ReturnStatement', 'ThrowStatement', 'VariableDeclarationStatement', 'WhileStatement'];
    ...
    if (Array.isArray(c)) {
      ...
      switch (c.type) {
        ...
        case 'DoWhileStatement': {
          ...
          if (triviallyNotBreakOrContinueTypes.includes(c.body.type)) {
            yield replace(c.body);
          }
